...
public class StudentMessagesFragment extends Fragment {
    ...
    private void getStudentMessages() {
        FirebaseRecyclerAdapter<MessagesStudent, StudentMessagesFragment.StudentMessagesViewHolder> messageAdapter = new FirebaseRecyclerAdapter<MessagesStudent, StudentMessagesFragment.StudentMessagesViewHolder>
                (
