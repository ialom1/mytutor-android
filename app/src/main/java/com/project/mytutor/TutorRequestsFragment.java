...
public class TutorRequestsFragment extends Fragment {
    ...
    private void getTutorRequests() {
        ...
        FirebaseRecyclerAdapter<RequestsTutor, TutorRequestsFragment.ReqViewHolder> requestAdapter = new FirebaseRecyclerAdapter<RequestsTutor, TutorRequestsFragment.ReqViewHolder>
                (
                        RequestsTutor.class,
