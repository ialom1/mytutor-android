...
public class StudentRequestsFragment extends Fragment {
    ...
    private void getStudentRequests() {
        FirebaseRecyclerAdapter<RequestsStudent, StudentRequestsFragment.StudentReqViewHolder> requestAdapter = new FirebaseRecyclerAdapter<RequestsStudent, StudentRequestsFragment.StudentReqViewHolder>
                (
