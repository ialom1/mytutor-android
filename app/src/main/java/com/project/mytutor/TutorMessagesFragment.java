...
public class TutorMessagesFragment extends Fragment {
    ...
    private void getTutorMessages() {
        FirebaseRecyclerAdapter<MessagesTutor, TutorMessagesFragment.TutorMessagesViewHolder> messageAdapter = new FirebaseRecyclerAdapter<MessagesTutor, TutorMessagesFragment.TutorMessagesViewHolder>
                (
                        MessagesTutor.class,
